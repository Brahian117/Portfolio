...
export const Hero = () => {
  ...
  useEffect(() => {
    setTimeout(() => setShow(true), 100) // animación con retraso
  }, [])
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          >
            <button className="btn-primary px-6 py-3" onClick={() => scrollTo('projects')}>
              View Projects
            </button>
            <button className="btn-ghost px-6 py-3" onClick={() => scrollTo('contact')}>
              Contact
            </button>
          </div>
